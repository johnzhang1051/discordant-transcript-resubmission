...
# Load main data
Gene_transcript_pearson <- read.csv("Data/merged_spearman_annotated_stringent.csv")
...
# Plot
ggplot(Gene_transcript_pearson, aes(x = Spearman_gene, y = spearman_transcripts)) +
  # Background points
  geom_point(
