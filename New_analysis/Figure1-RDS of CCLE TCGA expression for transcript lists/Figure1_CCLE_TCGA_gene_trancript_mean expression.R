expression_gene <- readRDS("Data/Figure1_CCLE_Gene_All_finallist.rds")
...
transcript_expression <- readRDS("Data/Figure1_CCLE_transcript_ALL_final_list.rds")
...
df_expr <- expression_gene[, c(3, 4:112)]
...
df_expr <- transcript_expression[, c(3, 4:132)]
...
long_expr <- expression_gene %>%
  pivot_longer(cols = 4:112, names_to = "TranscriptID", values_to = "Expression")
...
long_expr <- transcript_expression %>%
  pivot_longer(cols = 4:132, names_to = "TranscriptID", values_to = "Expression")
