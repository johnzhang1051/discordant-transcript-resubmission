...
old_discordant <- read.csv("CoCor_analysis/NEW_discordant_protein_coding.csv")

# Extract column 2 from old_discordant
old_ids <- old_discordant[[2]]

# Find overlap
overlapping_ids <- intersect(old_ids, CoCor_final_protein_coding$transcript_ID)
